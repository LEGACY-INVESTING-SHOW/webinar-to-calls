...
| Annual cash flow, base with 18% co-host (the B3 staffing case from OP.7) | -$7,798 | -$6,924 |
...
Maya and Chris plan about 10 personal-use days a year at Cedar Ridge. Don't guess the occupancy type from that number. Tell the lender your real plan and let the lender classify it. Fannie Mae's [general rental income section, B3-3.8-01](https://selling-guide.fanniemae.com/sel/b3-3.8-01/rental-income) says rental income from a principal residence or second home generally can't be used to qualify. It lists narrow exceptions. So the occupancy type also decides whether STR income is even on the table.

The fourth is reserves and your other properties. Fannie Mae's [reserve rules, B3-4.1-01](https://selling-guide.fanniemae.com/sel/b3-4.1-01/minimum-reserve-requirements) add reserve requirements in one situation: the borrower has multiple financed properties and the new loan is on a second home or investment property. The requirement grows with the number of financed properties. Fannie Mae also sets rules on how many financed properties one borrower can have ([B2-2-03](https://selling-guide.fanniemae.com/sel/b2-2-03/multiple-financed-properties-same-borrower)). Maya and Chris would have two: their home and Cedar Ridge.
...
I need two numbers the canonical file doesn't give. Say their primary home payment (principal, interest, tax, insurance) is $2,400 a month (assumption). Car and card payments are $600 a month (assumption, the same figure 0.3 used).

Today: ($2,400 + $600) / $15,417 = **19.5%**

Add the full Cedar Ridge conventional PITIA of $2,484 and count zero rental income:

($2,400 + $600 + $2,484) / $15,417 = **35.6%**

At 35.6%, they'd sit just under the 36% manual-underwriting limit, even with no income credit for the STR. They'd be well under the 45% and 50% limits. Their DTI rules depend on their actual debts, credit, reserves, and the underwriting system the lender uses, so treat this as a screening check.

This matters for the decision tree later. Through DU, or with the credit and reserves for 45%, the STR income question may not decide their loan. On a manual file, 35.6% leaves almost no room. For a buyer whose DTI is already near the limit, the STR income question can decide everything.
...
[Production note: before recording, the lender reviewer should read B3-3.8-03 in full and replace this list with its exact conditions. See the Unresolved list in parts/sources-D.md.]
...
Here are both loans over 60 months. All figures are assumptions from the canonical quotes.
...
1. Is your DTI with the new full payment and no rental income under the lender's limit? If yes, get a conventional quote first. If no, treat your file as Branch C: the loan may depend on how the lender counts STR income.
...
Step 1. DTI with the full conventional PITIA and no STR income: 35.6% (illustration, assumptions). That's just under the 36% manual limit and well under the higher limits described above. Conventional quote first.
