...
That last line invites the objections now, while you have your evidence ready.
...
The last row is honest about limits. Some objections can't be solved by the operator. If the owner's own insurer excludes short-stay use, or the owner believes the mortgage forbids it, the owner has to resolve that. Offer to wait while they check, and log the result.
...
A pass log keeps you honest. It also shows you patterns. If three owners in a row cite their building insurer, that's worth knowing before your next pitch.
