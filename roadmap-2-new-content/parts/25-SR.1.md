...
Use it with Sam's 3.2 (How to Research Regulations Before You Sign Anything) for the live search method, and with Sam's PA.2 when you screen ownership markets. Sam shows you where to click. This sheet is where you write down what you found and what you decided.
...
- **"Unresolved" means do not sign.** You can keep negotiating, but you do not sign a lease, release a deposit, or waive a contingency on an unresolved address.
...
Alder Street is a hypothetical two-bedroom, two-bath apartment (Unit 4B) in a four-unit building, leased from a small landlord. It sleeps 5. The student does not live there. The plan is to rent the whole unit to guests, with an average stay of 3.0 nights and 255 booked nights a year (all figures from the canonical example, assumptions). The canonical file leaves the city unnamed on purpose. Here we drop the unit into New York City to test the template against the official rules.
...
All rows checked 2026-09-25 by official-domain search of nyc.gov (the page could not be opened directly from this environment; open it yourself before relying on it). Reviewer for this test: course team. Real use needs an NYC attorney as second reviewer.
...
An unresolved sheet is useful. It tells you exactly which five emails to send and which contingency dates matter.
...
**Confirm with:** a local short-term rental attorney, that the permitted / prohibited decision is right for this address, this plan, and this lease or purchase contract.
