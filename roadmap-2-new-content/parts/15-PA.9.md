...
**The buy-box check.** Cash isn't the only rule they brought from earlier lessons. PA.1's cash caps still pass: cash to close stays $110,688, cash to close plus furnishing stays $142,688, and the $2,955 punch list is under their $4,000 limit. But PA.1 and PA.8 wrote down two more rules. The weak case may lose no more than $6,000 a year. Base NOI must be at least 1.20 times annual P&I. The first rerun breaks both.
...
Now the decision. The house is sound enough to buy. The final budget meets both buy-box rules and the cash test, each with a thin margin. Maya and Chris decided to proceed. They wrote down why: the roof and routine septic and well costs are funded from B1's reserve lines, and the permit is the only new cost. They also wrote a new rule. If the first 12 months run closer to the weak case, they revisit the co-host and pricing plan at the 12-month review in OP.11.
