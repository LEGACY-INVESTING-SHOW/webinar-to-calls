...
The point bands in the table and these label cut-offs are my teaching defaults (assumption), not industry rules. Tighten them if the unit depends on one employer or one event.
