...
Up to now, your team was the closing team: agent, lender, inspector, title company, attorney. Now your team is the launch team: insurer, cleaner, handyman, furnishing help, and maybe a co-host. Sam's OP.1 to OP.5 cover the listing and software.
...
You bound a policy before closing, because the lender required it. Now read it as the operator. The lender cared that the house was insured. You care whether a guest injury, a burst pipe, or a month without bookings is covered.
...
2. Water. A well has no water bill. It does have a pump, a pressure tank, and the UV system the seller installed under the PA.9 amendment. Write down where the shutoff is and when the UV lamp is due.
...
Carrying costs run with no revenue. Monthly PITIA on the DSCR loan is $2,557. Utilities, internet, and trash are $450 a month. Software is $100 and the handyman retainer is $150. That's $3,257 a month, the same carrying cost 0.3 used. For 45 days, that's $3,257 × 1.5 = $4,885.50.
...
The canonical total cash in of $142,688 already includes the $32,000 furnishing. Maya and Chris had $231,000 of liquid savings when they made the offer in PA.8. So: $231,000 - $142,688 - $2,955 - $4,885.50 = $80,471.50 left. That doesn't count anything they've saved since the offer.

Their set-asides come out of that $80,471.50. The property reserve is six months of PITIA ($15,342). The emergency fund is $51,000. The weak-year reserve is $11,750, two years of PA.9's -$5,875 weak case. Together that's $78,092, which leaves $2,379.50 unallocated. On paper, that's under the $10,000 floor from PA.8.6. The three months of saving since the offer, about $10,500 at $3,500 a month (assumption, from 0.3), put them back above it.

If the permit takes longer, each extra month costs another $3,257, and it comes out of the property reserve. That's the number to watch.
...
**Confirm with:** your CPA. They confirm the bookkeeping records and accounts to set up now. They also confirm the date the property is ready and available to rent, which affects depreciation timing in Sam's PA.5.
