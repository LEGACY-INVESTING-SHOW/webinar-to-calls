...
By the end of this lesson you can run a landlord conversation that ends in one of two documented outcomes: written approval with a signed addendum, or a clear pass that you log and move on from. You'll have a 60-second opening, an evidence packet that answers the regulation and liability objections, and an accurate way to explain the difference between your insurance and a platform's protection program.
...
Start with what Airbnb itself says. Its AirCover for hosts program includes Host damage protection and Host liability insurance, and Airbnb states that Host damage protection isn't an insurance policy ([Airbnb Help, article 3733](https://www.airbnb.com/help/article/3733)). So don't call it insurance.

Host damage protection has conditions. Airbnb's help pages say a reimbursement request has to be filed within 14 days of the responsible guest's checkout, that wear and tear isn't covered, and that a request can be denied if the loss came from the host's failure to take reasonable care ([Airbnb Help, article 279](https://www.airbnb.com/help/article/279)). Verify the current terms before you describe them.

Host liability insurance is actual insurance, underwritten by third-party insurers, and it has terms, conditions, and exclusions ([Airbnb Help, article 3145](https://www.airbnb.com/help/article/3145)). The program summary lists exclusions including injury or damage the insured intended or should have expected, fungi or bacteria, and liability assumed under a contract. It also describes the host's landlord as an insured only for liability arising from the host's accommodation during an Airbnb stay, with stated exceptions ([Airbnb Help, article 3145](https://www.airbnb.com/help/article/3145)). Coverage applies to stays booked on Airbnb. Bookings on Vrbo or your direct site aren't part of Airbnb's program.
...
**Confirm with:** your insurance broker what your STR policy covers, whether it covers all booking channels, and whether the landlord can be added as an additional insured. Confirm current Airbnb program terms on the official help pages before recording or pitching.

### 5.7.6 Worked example: the Alder Street role play

Setting: assume (assumption) the unnamed city allows unhosted stays with an annual permit that needs the owner's signed consent. You've cleared the Alder Street hard stops in 3.4, with the licensing office's written answer saved. You've drafted an addendum with lesson 3.5's ten topics. The landlord, who owns the four-unit building, has agreed to a call. Canonical figures: rent $1,950 a month, 24-month lease, sleeps 5, about 85 stays a year at 3 nights average, STR liability insurance at $1,300 a year, permit at $250 a year. All are assumptions for teaching.
...
**Ending A: written approval.** Dana's attorney asks for one change: a 30-day cure period instead of 15. You accept. Dana signs the lease and the addendum. You send a confirmation email the same day listing what's signed and what's still due from you (the declarations page and the permit number). The 3.4 scorecard rows L1 and L2 drop to 0.
...
For a pass, the email should thank the owner, state the reason they gave in neutral words, and ask whether you can check back if their situation changes. Then log it:
