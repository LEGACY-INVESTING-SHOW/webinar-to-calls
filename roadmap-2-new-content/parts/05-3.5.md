...
By the end of this lesson you can read a lease and tell whether it gives you explicit written authority to run short stays, or only something that sounds like permission. You'll know the ten topics written consent should cover, what to disclose to the owner about how you operate, and which questions go to an attorney or insurer. You'll leave with a completed consent review for one lease.
...
The law can treat the two differently too. New York's Real Property Law section 226-b gives some tenants in buildings with four or more units a right to sublease with the landlord's advance written consent, which the landlord can't unreasonably withhold ([NY RPL 226-b](https://www.nysenate.gov/legislation/laws/RPP/226-B)). That statute sets out a notice process built around a named subtenant and a sublease term. It doesn't answer whether repeated stays under 30 days are legal. New York City answers that separately, and for whole units the answer is no ([NYC OSE tips for hosts](https://www.nyc.gov/site/specialenforcement/registration-law/tips-for-hosts.page)). So a tenant could have a sublet right and still have no lawful path to short stays.
...
**Confirm with:** an attorney licensed in the property's state whether the lease, state law, and local code treat your plan as a sublet, a license to occupy, a hotel-type use, or something else. The label can change which rules apply.

### 3.5.2 What "written authority" actually means

Written authority has four parts. If any one is missing, you don't have it yet.

First, the right person signs. That's the owner of record or an agent with written authority to bind the owner. A leasing agent who says "should be fine" may have no authority to change the lease. Check the owner's name against the county property record, and if an agent signs, ask for the management agreement page or a letter that shows their authority.
...
Landlord consent also has limits. It can't override a city ban, a primary-residence rule, or an HOA restriction. Airbnb's own guidance tells hosts to read the lease, check with the landlord, and check HOA or co-op rules for any restriction before hosting ([Airbnb Help, article 1397](https://www.airbnb.com/help/article/1397)). Some cities also make the landlord's written approval part of the permit itself. Los Angeles requires written landlord approval before a renter can register for home-sharing, and the city publishes a landlord authorization form for that purpose ([LA City Planning Home-Sharing FAQ](https://planning.lacity.gov/ordinances/docs/HomeSharing/adopted/faq.pdf); [LA landlord authorization form](https://planning.lacity.gov/odocument/b044ea0f-be5d-4da5-8144-18b0c3fad092/AFFIDAVIT.pdf)). Los Angeles also limits home-sharing to a primary residence, so that form alone doesn't make an arbitrage plan legal there.
...
>
> **1. Permitted use.** Landlord consents to Tenant using the Premises for furnished stays of fewer than 30 nights by paying guests ("Short-Term Stays"), in addition to any use the Lease otherwise permits, for the full Lease term and any renewal.
>
...
>
> **4. Compliance.** Tenant will obtain and keep current every permit, registration, and tax account the jurisdiction requires for Short-Term Stays, and will display any required registration number in listings. Landlord will sign any owner consent or authorization form the jurisdiction requires within 10 business days of request.
>
> **5. Insurance.** Tenant will maintain short-term-rental liability insurance with limits of at least $[amount] per occurrence, naming Landlord as an additional insured where the insurer permits. Tenant will deliver the declarations page before the first stay and at each renewal.
>
...
>
> **8. Change in law.** If a change in law or a regulator's written determination prohibits Short-Term Stays at the Premises, either party may, on 30 days' written notice, convert this Lease to a standard residential tenancy on the existing terms or end the Lease without penalty.
>
...
**Confirm with:** an attorney licensed in the property's state before using any clause above, including whether change-in-law and cure terms are enforceable and how they interact with local tenant protections.
...
Item B is the L1 flag from 3.4. Let's put a number on the risk. Your sunk setup cost is $12,050 (canonical). At the base-case net of $1,018 a month, payback takes 11.8 months. If the landlord ends the lease with 60 days' notice after month 6, you'd have earned back about $6,108 ($1,018 × 6), leaving about $5,942 unrecovered, before the final two months of operations. In the stress case, at $129 a month, you'd have recovered only $774 by month 6. Result: ask for clause 9 of the illustrative addendum (breach and cure) and a statement that clause 14 doesn't apply while the addendum is in force.
...
With a signed addendum covering these rows, L2 in the 3.4 scorecard drops from 1 to 0, and L1 drops from 2 to 0 if the landlord accepts breach-and-cure in place of no-cause termination.
...
**Confirm with:** an attorney licensed in the property's state whether the lease and addendum give explicit authority for short stays, whether any state sublet statute applies, and whether the termination, cure, and change-in-law terms are enforceable.

**Confirm with:** the local licensing or planning office whether the permit requires the owner's signature or a landlord authorization form, and whether a renter can hold the permit at all.
