...
By the end of this lesson you can run any address through a two-stage screen and label it **reject**, **investigate**, or **advance** in about an hour of desk work. Stage one checks six hard stops that end a deal on their own. Stage two scores thirteen commercial and lease red flags with fixed point rules. You'll finish with a filled scorecard for one real address and a written list of what must be confirmed before you spend another hour on it.
...
**H1. The planned use is prohibited at this address.** Many cities separate hosted stays (you live there and rent part of it) from unhosted stays (the whole unit goes to guests while you're elsewhere). An arbitrage unit is almost always unhosted. If the city bans unhosted stays under a set number of nights, the arbitrage plan fails at that address. New York City is the clearest example. The city's Office of Special Enforcement says hosts can't rent an entire apartment or home to visitors for fewer than 30 days, and that short stays require the host to stay in the unit with no more than two guests ([NYC OSE tips for hosts](https://www.nyc.gov/site/specialenforcement/registration-law/tips-for-hosts.page)).
...
**H6. No insurer will cover the planned use.** If you can't get a short-term-rental liability policy for this unit and this use, you can't meet any sensible lease or addendum. Platform programs don't fill the gap. Airbnb states that Host damage protection isn't an insurance policy ([Airbnb Help, article 3733](https://www.airbnb.com/help/article/3733)). Lesson 2.4 covers insurance in detail.

Notice what's missing from this list: "the city is expensive" and "I read a bad news story." Those are commercial questions. Hard stops are yes-or-no facts you can confirm in writing.

**Confirm with:** the local licensing or planning office (H1 to H3, in writing, with the date), the HOA or building manager (H4), the landlord and your attorney (H5), and your insurance broker (H6).
...
In New York City, an arbitrage operator renting out the whole unit for three-night stays runs straight into H1. The city allows short stays only when the host is present with up to two guests, and whole-unit stays under 30 days are out ([NYC OSE tips for hosts](https://www.nyc.gov/site/specialenforcement/registration-law/tips-for-hosts.page)). The OSE also says New York State counts the check-in date as day zero, so a 29-night rental is still short-term.

In Los Angeles, the same operator runs into H2 and H3. Home-sharing is limited to the host's primary residence, and the registration doesn't transfer ([LA City Planning FAQ](https://planning.lacity.gov/ordinances/docs/HomeSharing/adopted/faq.pdf)). There's a second layer. The Los Angeles Housing Department says home-sharing isn't allowed in units covered by the Rent Stabilization Ordinance, which applies to most multi-family units built before October 1, 1978 ([LAHD Home-Sharing Ordinance](https://housing.lacity.gov/articles/home-sharing-ordinance)). So the building's age can end the deal before you even get to the residence rule.

Both cities have large travel markets. Both have busy Airbnb supply. Neither works for this plan at a typical address. A friendliness ranking would miss that entirely, which is why your screen asks about the address and never about the city's reputation.
...
**C3. Weak comparable revenue.** Your revenue figures should come from active comparable listings with a full year of data, not from the best listing in the neighborhood. Sam's 4.2 and 4.3 lessons show how to pull those comps. If the comps don't support the nightly rate or occupancy you used, flag it.
...
**C5. High fixed rent relative to revenue.** Rent is the cost you pay whether guests show up or not. The higher it is as a share of gross revenue, the less room you have when revenue drops. (Lesson 1.5 covers the rent-multiple rule of thumb; I'm using the share of gross here because it scores cleanly.)
...
**L2. Unclear guest rights.** The lease or addendum should say that short-stay guests are permitted, how many can stay, how they get in, and which building areas they can use. Silence invites a dispute later.
...
**L5. A lease shorter than your payback.** If the stress-case payback on your setup cost runs past the lease term, you could hand back the keys before you've earned your money back.
...
| C6 Setup payback at base-case net | 12 months or less | 12 to 18 months | Over 18 months |
| C7 Cash reserve after setup | 2 or more months of rent plus utilities | 1 to 2 months | Under 1 month |
...
Stage one. For this walkthrough, assume (assumption) the city's official code allows unhosted stays with an annual permit costing $250, has no cap, and has no primary-residence rule. There's no HOA. The landlord is willing to sign an addendum. An insurer quoted STR liability coverage at $1,300 a year. So H1 to H6 all answer "no," provided the licensing office confirms H1 to H3 in writing.
...
How far does that reserve stretch? A slow 30-day month at 40% occupancy (assumption) and $180 ADR brings in about $2,600 and loses about $788 after all costs. The reserve could absorb five such months, but not a season of them.
...
**Confirm with:** the local licensing or planning office, in writing, whether unhosted stays are allowed at this exact address, whether a primary-residence test applies, and whether a permit is available to you as a non-owner operator.

**Confirm with:** the HOA, condo board, or building manager whether governing documents restrict short stays.

**Confirm with:** an attorney licensed in the property's state whether the lease and addendum give explicit permission, and whether termination and cure terms are enforceable as written.
...
An address that reaches "investigate" usually has a lease problem on the to-do list. Lesson 3.5, Sublease Legality & Landlord Disclosure Best Practices, shows you what written permission must actually say and how to tell a vague clause from an explicit one. Bring your scorecard and the landlord's draft lease.
